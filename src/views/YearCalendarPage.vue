...
useHead({
  title: computed(
    () => `Календарь на ${props.year} год — Годовой календарь онлайн`,
  ),
  meta: [
    {
      name: "description",
      content: computed(
        () =>
          `Календарь на ${props.year} год. Все месяцы ${props.year} года на одной странице. Удобный просмотр, печать, выбор даты. Поддержка тёмной темы.`,
      ),
    },
    {
      name: "keywords",
      content: computed(
        () =>
          `календарь ${props.year}, календарь на ${props.year} год, ${props.year} год календарь, годовой календарь ${props.year}, календарь онлайн`,
      ),
    },
    // Open Graph
    {
    ...
    },
    {
      ...
      content: computed(
        () =>
          `Календарь на ${props.year} год. Все месяцы ${props.year} года на одной странице. Удобный просмотр и печать.`,
      ),
    },
    {
      property: "og:url",
